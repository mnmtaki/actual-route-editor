...
function stripEditorArtifacts(svg: SVGSVGElement) {
  svg.querySelectorAll(
    '[data-editor="true"],.segment-hit,.station-hit-target,.station-selection-ring,[data-layer="opening-phase-preview"],[data-layer$="-active-overlay"],[data-layer="vector-basemap-active-overlay"]',
