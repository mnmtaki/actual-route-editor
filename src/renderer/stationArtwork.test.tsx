...
describe('shared ordinary StationArtwork', () => {
  ...
  it('renders built-in Shanghai side markers and Guangzhou number pills through the shared artwork', () => {
    ...
    expect(pill.container.querySelector('[data-guangzhou-pill="true"]')).toBeTruthy()
    expect(pill.container.querySelector('[data-guangzhou-pill-background="true"]')).toHaveAttribute('fill', 'white')
    expect(pill.container.querySelector('[data-guangzhou-pill-background="true"]')).toHaveAttribute('stroke', '#d34b44')
    expect(pill.container.querySelector('[data-guangzhou-divider="true"]')).toHaveAttribute('stroke', '#d34b44')
    expect(pill.container.querySelector('[data-guangzhou-pill-line="true"]')).toHaveAttribute('fill', '#202526')
    expect(pill.container.querySelector('[data-guangzhou-pill-station="true"]')).toHaveAttribute('fill', '#202526')
    expect(pill.container.querySelector('[data-guangzhou-pill-line="true"]')).toHaveTextContent('1')
    expect(pill.container.querySelector('[data-guangzhou-pill-station="true"]')).toHaveTextContent('01')
    expect(pill.container.querySelector('[data-transfer-arrow="true"]')).toBeNull()
    expect(pill.container.querySelector('[data-guangzhou-shell="true"]')).toBeNull()
  })
})
