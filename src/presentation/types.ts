...
export type HistoryEventType = 'LINE_OPENING' | 'LINE_EXTENSION' | 'LINE_REASSIGNMENT' | 'STATION_OPENING' | 'STATION_RENAME' | 'LINE_RENAME' | 'LINE_PARENT_CHANGE' | 'INTERCHANGE_CREATED' | 'SEGMENT_OPENING' | 'LINE_CLOSURE' | 'SEGMENT_CLOSURE'
...
export interface HistoryEvent {
  id: string
  type: 'LINE_OPENING' | 'LINE_EXTENSION' | 'LINE_REASSIGNMENT' | 'STATION_OPENING' | 'STATION_RENAME' | 'LINE_RENAME' | 'LINE_PARENT_CHANGE' | 'LINE_CLOSURE' | 'SEGMENT_CLOSURE'
