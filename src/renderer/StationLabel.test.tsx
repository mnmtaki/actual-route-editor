...
describe('StationLabel bilingual label group',()=>{
  ...
  it('lays out imported AARC labels as one anchored block, including multiline nameS',()=>{
    const aarc:Station={...station,source:{format:'aarc',pointId:57,nameP:[0,16.2],labelAnchorMode:'aarc-block',stationNameFontWeight:'bold',sourceStationNameRowHeight:52.5,sourceStationSubNameRowHeight:35},labelOffsetX:0,labelOffsetY:16.2}
