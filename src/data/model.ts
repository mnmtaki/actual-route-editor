...
export interface ActualRouteProject { version: 1; name: string; projectName?: string; distanceScale?: DistanceScale; stations: Station[]; lines: Line[]; stationLineRelations: StationLineRelation[]; openingPhases: OpeningPhase[]; operationEvents?: OperationEvent[]; lineDrafts?: LineDraft[]; geometry: { segments: Segment[] }; mapElements?: MapElement[]; textTags?: AarcTextTag[]; aarc?: AarcSourceMetadata; lineLegend?: LineLegend; basemapPaths?: BasemapPath[]; roads?: Road[]; roadStyles?: RoadStyle[]; background: BackgroundImage | null; timeline: TimelineSettings; presentation: PresentationSettings; settings: ProjectSettings; styles?: LineStyle[]; stationStyles?: StationStyle[]; defaultStationStyleId?: string; transferStyles?: TransferStyle[]; defaultTransferStyleId?: string }
