...
const SHOWCASE_CASES: Array<{ presetId: string; serviceCount?: number }> = [
  ...
  { presetId: 'transfer.kunming', serviceCount: 2 },
  { presetId: 'transfer.kunming', serviceCount: 3 },
  { presetId: 'transfer.kunming', serviceCount: 4 },
  { presetId: 'transfer.kunming', serviceCount: 6 },
