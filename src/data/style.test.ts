...
import { effectiveLabelRotation, inferLabelDirection, labelOffsetFor, resetVisualSettings, resolveLabelAnchor, resolveStationLabelDirection, snapLabelOffset } from './style'
